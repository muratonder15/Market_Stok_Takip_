...
namespace Market_Stok_Takip_MRT
{
    public partial class MusteriBorcEkleme : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            baglanti.sqlCalistir("update musteriler set devreden_borc=devreden_borc+'"+ textBox4.Text+"' where musteri_id="+musteri_id);
            ...
            baglanti.sqlCalistir("insert into hareketler (hareket_turu_kodu,islem_turu_kodu,odeme_turu_kodu,urun_id,islem_tarihi,toplam_tutar,cari_hesap_adi,islemi_yapan_kullanici_kodu,musteri_id) values(2,3,1,2,'"+DateTime.Now+"','"+  textBox4.Text+"','"+ cari_hesap_adi + "',"+ana_menu.kullanici_kodu+","+musteri_id+")");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cikis = MessageBox.Show("İşlemi kaydetmeden çıkmak istiyor musunuz?", "Uyarı", MessageBoxButtons.YesNo);
